...
import { App_Header, App_Footer, App_ItemID, App_Home, App_InFo, App_Notification, App_Cart, App_Add, App_SanPhamEdit, App_Search, App_EditProFile ,App_AnySV, App_BuySanPham } from './Compoment/Frame';
  ...
  return (
    ...
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route exact path="/buy/:sid"        element={<App_BuySanPham />} />
